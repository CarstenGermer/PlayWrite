/* debughelper.ahk, see https://www.autohotkey.com/boards/viewtopic.php?f=6&t=37113

    !ATTENTION! The Debug-Window is automatically cleared after a certain amount of output, 256x1024 chars.
	This may result in sudden stops of the whole script if the window is 'full'!
	See debughelper.ahk "InitDebugWindow: this.m_MaxSize := 256*1024"
...
Class Debug
{
	...
	InitDebugWindow()
	{
		...
		Gui, Font, q5 cAAAAAA s8,Courier New
		;Gui, Color, 000000, %DebugBackColor%
		;Gui, Font, c%DebugFontColor% w%DebugFontWeight% s%DebugFontSize%, %DebugFontName%

		Gui, Add, Edit, -Wrap +HScroll x0 y0 W800 H400 hwndhDebugWindow_TextBox_Control vDebugWindow_TextBox_Control 
